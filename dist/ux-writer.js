...
exports.improveUxWritingWithAI = improveUxWritingWithAI;
exports.mockUxWriting = mockUxWriting;
exports.improveUxWritingBatch = improveUxWritingBatch;
exports.detectTextType = detectTextType;
exports.detectTextTone = detectTextTone;
/**
 ...
 * @returns 개선된 텍스트
 */
async function improveUxWritingWithAI(apiKey, request) {
    var _a, _b, _c;
...
Return only the improved text, nothing else.`;
        ...
        const improvedText = (_c = (_b = (_a = data.choices[0]) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.content) === null || _c === void 0 ? void 0 : _c.trim();
        if (!improvedText) {
 ...
 * @returns 개선된 텍스트 배열
 */
async function improveUxWritingBatch(apiKey, texts, options = {}, onProgress) {
    const results = [];
    for (let i = 0; i < texts.length; i++) {
        ...
        if (apiKey) {
            // OpenAI API 사용
            const response = await improveUxWritingWithAI(apiKey, Object.assign({ text }, options));
